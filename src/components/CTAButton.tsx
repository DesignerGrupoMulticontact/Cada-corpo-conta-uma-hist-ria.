...
export const CTAButton: React.FC<CTAButtonProps> = ({ onClick }) => {
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full text-lg font-bold text-white shadow-xl shadow-[#6BAE2E]/25 overflow-hidden cursor-pointer whitespace-nowrap"
    >
      ...
      <span className="relative z-10 tracking-wide">Partilhar a minha história</span>
      <motion.span
        initial={{ x: 0 }}
        whileHover={{ x: 4 }}
