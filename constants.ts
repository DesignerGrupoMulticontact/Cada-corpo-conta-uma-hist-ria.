...
// Helper to title case district names
...
// Curated list of Districts for Map Labels (Clean, Uppercase, Portuguese)
export const DISTRICT_LABELS = [
  ...
  { name: "FUNCHAL", lat: 32.6669, lng: -16.9241 }, // Madeira
  { name: "PONTA DELGADA", lat: 37.7412, lng: -25.6756 }, // Açores
];
...
interface CityDef {
  lat: number;
  lng: number;
  dir?: SpreadDirection; // Preferential spread direction to avoid water
  spread?: number; // Custom spread magnitude (default 0.35 mainland, 0.05 islands)
}

// Expanded list to cover all districts keys
...
// Smart Jitter that respects geography
...
// Expanded Templates to avoid duplicates and ensure authenticity
